    ...
    <section id="content">
        ...
        <main>
            <div class="head-title">
                ...
                <a href="add_department.php" class="btn-download">
            ...
            <div class="table-data">
                <div class="order">
                    ...
                    <table>
                        ...
                        $query = "SELECT department.name AS dept_name, department.code, faculty.name 
    AS faculty_name, department.created_at
                  FROM department
